...
def execute_task6(request):
    ...
    if rel_feedback_type == 'Probabilistic':
        ...
        return render(request, 'visualize_images.html', {'images': initial_list_images, "from_task": "task6", "rel_type": rel_feedback_type,"q":q_name, "t":m})
...
def process_feedback(request):
    ...
    return render(request, 'visualize_images.html', {'images': new_rank_list, "from_task": "task6", "rel_type":rel_type, "q":q_name, "t":m})